...
public class PdfAPIHandler {
    ...
    private static final String PROMPT =
                """
                Extract all entities and their values from the uploaded PDF incident brief and return as JSON with the following instructions and without any content message:
                ...
                - Ensure incident brief numbers and dates are correctly mapped, like the following:
                -- Map any incident brief number to the field brief_number
                -- Map any incident brief date to the field "date"
                """;
